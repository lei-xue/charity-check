...
const ENTRIES = [
  ...
  { label: "St. Baldrick's Foundation" },
  { label: 'The Leukemia & Lymphoma Society', ein: 135644916, note: 'LLS rebranded to Blood Cancer United Inc in 2025; search 404s' },
  { label: 'American Diabetes Association' },
  { label: 'American Lung Association' },
  { label: 'National Kidney Foundation' },
  { label: 'The Michael J. Fox Foundation', query: 'Michael J Fox Foundation for Parkinsons Research' },
  { label: 'The ALS Association', query: 'Amyotrophic Lateral Sclerosis Association' },
  { label: 'Muscular Dystrophy Association' },
  { label: 'Easterseals' },
  { label: 'JDRF (Breakthrough T1D)', ein: 231907729, note: 'IRS name now Breakthrough T1d; search 404s' },
  { label: "Crohn's & Colitis Foundation" },
  { label: 'Arthritis Foundation' },
  { label: 'Epilepsy Foundation', query: 'Epilepsy Foundation of America' },
  ...
  { label: 'Fisher House Foundation' },
  { label: 'DAV (Disabled American Veterans)', query: 'Disabled American Veterans' },
  { label: 'Team Rubicon' },
  { label: 'Covenant House' },
  { label: 'Food for the Poor' },
  { label: 'Americares' },
  ...
  { label: 'Mercy Corps' },
  { label: 'International Medical Corps' },
  { label: 'Project HOPE' },
  { label: 'Partners In Health' },
  { label: 'PATH', ein: 911157127, note: 'IRS name Path; search 404s on the long query' },
  { label: 'Rotary Foundation', query: 'Rotary Foundation of Rotary International' },
  { label: 'DonorsChoose' },
  { label: 'Teach for America' },
  { label: 'City Year' },
  { label: 'Kiva', query: 'Kiva Microfunds' },
  { label: 'GiveDirectly' },
  ...
  { label: 'Defenders of Wildlife' },
  { label: 'The Conservation Fund' },
  { label: 'Trust for Public Land' },
  { label: 'Arbor Day Foundation', query: 'National Arbor Day Foundation' },
  { label: 'Wildlife Conservation Society' },
  { label: 'Dian Fossey Gorilla Fund', query: 'Dian Fossey Gorilla Fund International' },
  { label: 'PetSmart Charities' },
  // —— Arts & education ——
  { label: 'Metropolitan Museum of Art' },
  { label: 'Museum of Modern Art', ein: 131624100 },
  { label: 'Sesame Workshop' },
  { label: 'Code.org', ein: 460858543, note: 'IRS name Code Org; search API 404s on the dotted query' },
  { label: 'Girls Who Code' },
  { label: 'FIRST Robotics', query: 'For Inspiration and Recognition of Science and Technology' },
  // —— Civil & human rights ——
  { label: 'NAACP Legal Defense Fund', ein: 131655255, note: 'IRS name N A A C P Legal Defense And Educational Fund Inc; search top-hit is the wrong org (Voter Fund)' },
  { label: 'Southern Poverty Law Center' },
  { label: 'Human Rights Campaign Foundation' },
  { label: 'Lambda Legal', query: 'Lambda Legal Defense and Education Fund' },
  { label: 'Anti-Defamation League' },
  { label: 'Amnesty International USA' },
